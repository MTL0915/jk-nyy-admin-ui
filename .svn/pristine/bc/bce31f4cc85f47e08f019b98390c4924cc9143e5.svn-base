<template>
    <div class='baiduVideoBox' v-show='isOpen' :style="'bottom:'+bottom+'px;right:'+right+'px;width:'+width+'px;height:'+height+'px;'">
        <div v-show='isShow && !isBig' class='title' @mousedown="drag">
            <span>摄像头</span>
            <div class='smallBtn'>
