<template>
  <el-dialog :visible.sync="dialog" :title="isAdd ? '添加菜单' : '编辑菜单'" append-to-body width="600px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="是否隐藏" prop="hide">
        <el-radio v-model="form.hide" label="true">是</el-radio>
        <el-radio v-model="form.hide" label="false" >否</el-radio>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      form: { name: '', sort: 999, path: '', component: '', iframe: 'false', hide: 'false', roles: [], pid: 0, icon: '' },
      rules: {
        name: [
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.form = { name: '', sort: 999, path: '', component: '', iframe: 'false', hide: 'false', roles: [], pid: 0, icon: '' }
    },
    selected(name) {
      this.form.icon = name
    },
