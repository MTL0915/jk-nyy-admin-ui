...
class map {
   ...
   * @returns {any}
   */
  initMap( Map, Basemap, MapView, SceneView, TileLayer, Graphic, BaseTileLayer, TileInfo,WebTileLayer, SpatialReference, GraphicsLayer, IntegratedMeshLayer, Color, geometryEngine, Polygon, Point, Polyline, Draw, SketchViewModel, ObjectSymbol3DLayer, PointSymbol3D, webMercatorUtils) {
    // 将加载的默认对象保存在esri里面
    this.esri = { Map, Basemap, MapView, SceneView, TileLayer, Graphic, BaseTileLayer, TileInfo,WebTileLayer, SpatialReference, GraphicsLayer, IntegratedMeshLayer, Color, geometryEngine, Polygon, Point, Polyline, Draw, SketchViewModel, ObjectSymbol3DLayer, PointSymbol3D, webMercatorUtils };
    esri = { ...this.esri };
