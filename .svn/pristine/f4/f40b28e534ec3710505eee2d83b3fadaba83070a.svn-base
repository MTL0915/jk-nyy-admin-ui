<template>
  <div>
    ...
    <div id="device-inner-detail" style="width:100%;display: flex;flex-wrap: wrap;" >
        <div v-for="(property,i) in propertys" :key="i" class="device_property_container">
...
export default {
  ...
  watch:{
    hd_device_id:function(val){
      this.showDevicePropertyValue(this.hd_device_id);
    }
  },
  methods: {
