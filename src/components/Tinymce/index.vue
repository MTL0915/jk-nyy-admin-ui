...
// const tinymceCDN = require('./tinymce.js')
// import e from './tinymce.js'
...
export default {
  ...
  methods: {
    ...
    //  tinymce.PluginManager.add( 'my_button_script', tinymce.plugins.MyButtons );
      ...
      let toolbars = this.toolbar.length > 0 ? this.toolbar : toolbar
        ...
        setup(editor) {
          ...
          editor.on('KeyDown',function(e){
            if( ( e.keyCode == 8 || e.keyCode == 46 ) && editor.selection ){// delete& backspace keys 
              ...
              }else if( selectedNode && selectedNode.nodeName =='P' ){
                // 如果删除的是标记的行 则娶当前行最后一个
                selectedNode.children[selectedNode.children.length-2]
              }
            }
          })
        },
