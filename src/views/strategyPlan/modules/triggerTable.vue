  ...
  <div>
    <div>
      <el-table
        ...
        <el-table-column align="center" label="控制策略">
          <template slot-scope="scope">
            <span>溶解氧 原始值 < 15 ml 持续2个周期 则启动</span>
          </template>
        </el-table-column>
    ...
    <el-dialog title="触发策略详情" :visible.sync="dialogVisible" width="80%" append-to-body>
      <myForm  ref="myForm"/>
    </el-dialog>
  </div>
</template>
...
import myForm from "./triggerForm"
export default {
  components: {
    myForm
  },
