<template>
  <div style="height:100%">
    <div class="menus">
      <el-button size="small" type="primary" icon="el-icon-plus" @click="add">创建控制策略</el-button>
    ...
    <div class="table">
      <listTable :strategyList="strategyList1" ref="listTable" />
    </div>
...
<script>
import listTable from "./timerTable"
  ...
  data() {
    return {
      ...
      strategyList1: [
        {
          name: "测试",
          triggers_sensor_name: "增氧机",
          rs_facilities_name: "溶解氧 原始值 < 15 ml 持续2个周期 则启动",
          status: 1
        }
      ],
      strategyList: [], //策略列表
