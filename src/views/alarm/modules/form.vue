    ...
    <div>
      ...
      >
        ...
        <div class="card">
          ...
          >
            <div
              v-for="(rules, indexs) in form.alarmRules"
              :key="indexs"
            >
              若<el-select
                v-model="rules.hd_device_sensor_id"
                placeholder="请选择传感器"
