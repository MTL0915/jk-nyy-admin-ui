...
export default {
  ...
  methods: {
    ...
    showAdd (agroProduceArchiveCycleId, agroProductEnvId, agroProduceArchiveEnvDTOs) {
      this.form = {};
      ...
      this.form.agroProductEnvId = agroProductEnvId;
      this.form.agroProduceArchiveCycleId = agroProduceArchiveCycleId;
    ...
    doSubmit () {
      ...
      var checkedNodes = this.$refs.sensorTypeCascader.getCheckedNodes();
      if (checkedNodes) {
        this.form.hd_sensor_type_function_name = checkedNodes[0].label;
      }

      this.agroProduceArchiveEnvDTOs.push(this.form);
      this.dialog = false;
    },
    resetForm () {
      this.dialog = false
