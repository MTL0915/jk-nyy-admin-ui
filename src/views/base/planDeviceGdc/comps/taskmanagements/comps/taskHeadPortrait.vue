<template>
    ...
    <div class='headBox'>
        <div class='row1 head'> 
            <!-- 头像 -->
            <div class='headImage'>
                <img @click='deviceCenter' class='headIcon' title="定位设备" :src='hd_device_type_image_path' />
            </div>
            <div class='a1'>
                <div class="a2">
                    ...
                    <div class="a4">
                        ...
                        <span v-if='device.state != 0 && device.state != 5' style='color:#00ff50;'> 在线 </span>
                        <span v-if='device.state == 0' style='color:#ff0000;'> 离线 </span>
                        <span v-if='device.state == 5' style='color:#00ff50;'> 待机 </span>
                    </div>
                </div> 
                <div class="a6">
                    <div class="a7">{{getPowerValue}}电量</div> 
                    <div class='a8'>
                        <div class="a9" :style='"max-width:100%;width:"+getPowerValue'></div>
                    </div>
                </div>
            </div>
        </div>
        <div class='row2'>
            <div class='row2_btn'>
                <span >电源开关</span> 
                <div class='switch' @click='clickPowerConfirm'> 
                    <el-switch v-model="isPower" size="mini" active-color="#13ce66"  :disabled='disPower' inactive-color="#ff4949"> </el-switch>
                </div>
            </div>
            <div class='row2_btn cur' :class='{active: property_values.rd_sta === 1}'>
                <span>障碍物报警</span>
                <span> <img v-if="property_values.rd_sta === 1" :src='require("@/assets/img/Plan/drawLineMap/qp/zhangaiwu.png")' /> </span>
            </div>
        </div>
        <div class='row3'>
            <div class='row2_btn'>
            ...
            <div class='row2_btn cur' :class='{active: property_values.nav_cmd == 5}'>
                ...
                <span v-if="property_values.nav_cmd === 5"  @click='stopRouteJob'> <img style="cursor:pointer" :src='require("@/assets/img/Plan/drawLineMap/qp/tuichu.png")' /> </span>
            </div>
        </div>
    </div>
</template>
