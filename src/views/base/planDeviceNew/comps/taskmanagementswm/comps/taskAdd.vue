<template>
  <div class="addTask" v-show="isShow">
    <!-- 头部 -->
    ...
    <div class="">
      ...
      <div class="addTaskModel">
        ...
        <div>
          <input class="inputStyle" type="text" v-model="form.taskName" />
        </div>
      </div>
      <div class="addTaskModel">
        ...
        <div>
          ...
          >
            <option v-for="(it, i) in taskType" :key="i" :value="it.id">{{
              it.name
            }}</option>
          </select>
        </div>
      ...
      <div class="addTaskModel">
        ...
        <div>
          <input type="text" v-model="form.czjs" class="taskType inputStyle" />
        </div>
      </div>
      ...
      <div class="addTaskModel">
        <div class="drawBtn" @click="draw" v-show="isDraw">
          <span>绘制</span>
